<template>
	<VCard class="rounded-xl elevation-0 bg-light-frost">
		<VCardText>
			<VRow>
				<VCol>
					<h2 class="mt-2 text-center text-uppercase text-primary">👤 Members</h2>
				</VCol>
			</VRow>

			<VRow v-for="(a, i) in this.members" :key="i">
				<VCol md="1" lg="1">
	...
	export default defineComponent({
		...
		methods: {
			...
			async getMembers(): Promise<void>
			{
				...
				this.members = await this.$store.state.contract.yieldSyncV1VaultRegistry.methods
