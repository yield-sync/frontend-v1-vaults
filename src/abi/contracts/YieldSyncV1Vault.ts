...
export interface YieldSyncV1VaultInterface extends utils.Interface {
  functions: {
...
export interface YieldSyncV1Vault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: YieldSyncV1VaultInterface;
