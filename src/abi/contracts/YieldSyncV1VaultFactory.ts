...
export interface YieldSyncV1VaultFactoryInterface extends utils.Interface {
  functions: {
...
export interface YieldSyncV1VaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: YieldSyncV1VaultFactoryInterface;
  ...
  functions: {
    ...
    ): Promise<[BigNumber] & { yieldSyncV1VaultId: BigNumber }>;
    ...
    yieldSyncV1VaultId_yieldSyncV1VaultAddress(
      ...
      overrides?: CallOverrides
    ): Promise<[string] & { yieldSyncV1VaultAddress: string }>;
  };
