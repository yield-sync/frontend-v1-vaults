export default [
	...
	},
	{
		"anonymous": false, "inputs": [
			{
				"indexed": true, "internalType": "uint256", "name": "supply", "type": "uint256"
			},
		], "name": "SupplyChanged", "type": "event"
	},
	{
		"anonymous": false, "inputs": [
			{
	...
	{
		"inputs": [
		], "name": "availableTokenCount", "outputs": [
			{
	...
	},
	{
		...
		], "name": "ownerMallardCount", "outputs": [
			{
				"internalType": "uint256", "name": "", "type": "uint256"
			},
		], "stateMutability": "view", "type": "function"
